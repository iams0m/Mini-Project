			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<div class="post-heading">
						<h1>${bag.festa_title}</h1>
						<h2 class="subheading">${bag.brief_contents}</h2>
						<span class="meta"> ${bag.festa_area} ${bag.festa_date} </span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-md-10 col-lg-8 col-xl-7">
					<a href="#!"><img class="img-fluid"
						...
						class="caption text-muted">${bag.festa_title}</span>
					<h2 class="section-heading">상세 정보</h2>
					<p>${bag.festa_detail}</p>
